...
<FileTree>
  - src - app.ts - Express app configuration - server.ts - Entry point - domain/
  - Domain Driven Design modules - lib/ - Shared libraries - middleware/ -
  Express middlewares (Auth, Logging) - routes/ - API Route definitions - test/
  - Integration tests - package.json - tsconfig.json
</FileTree>
