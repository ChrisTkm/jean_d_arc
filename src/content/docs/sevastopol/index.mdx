...
**Sevastopol** es la interfaz de usuario del sistema contable, construida con **Astro**, **SolidJS** y **Tailwind CSS**. Implementa una arquitectura moderna de islas para interactividad y generación estática para rendimiento.

## Estructura del Proyecto

<FileTree>
  - src - components/ - UI/Shared components - config/ - Configuration files -
  icons/ - SVG Icons - layouts/ - Layout.astro - lib/ - Utilities and helpers -
  middleware.ts - pages/ - File-based routing - styles/ - Global styles - types/
  - TypeScript definitions - package.json - astro.config.mjs -
  tailwind.config.mjs
</FileTree>
